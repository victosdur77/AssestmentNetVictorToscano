...
namespace AssestmentNET_VictorToscanoDuran.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(victortoscanodatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var victortoscanodatabaseContext = _context.Vehicles.Include(v => v.Owner);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'victortoscanodatabaseContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
